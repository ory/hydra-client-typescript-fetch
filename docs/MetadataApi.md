...
import type { GetVersionRequest } from '@ory/hydra-client-fetch';
...
import type { IsAliveRequest } from '@ory/hydra-client-fetch';
...
import type { IsReadyRequest } from '@ory/hydra-client-fetch';
