...
import type { CreateOidcDynamicClientRequest } from '@ory/hydra-client-fetch';
...
import type { CreateVerifiableCredentialRequest } from '@ory/hydra-client-fetch';
...
import type { DeleteOidcDynamicClientRequest } from '@ory/hydra-client-fetch';
...
import type { DiscoverOidcConfigurationRequest } from '@ory/hydra-client-fetch';
...
import type { GetOidcDynamicClientRequest } from '@ory/hydra-client-fetch';
...
import type { GetOidcUserInfoRequest } from '@ory/hydra-client-fetch';
...
import type { RevokeOidcSessionRequest } from '@ory/hydra-client-fetch';
...
import type { SetOidcDynamicClientRequest } from '@ory/hydra-client-fetch';
