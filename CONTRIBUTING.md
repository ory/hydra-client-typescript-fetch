...
# Contribute to Ory hydra-client-typescript-fetch<!-- omit in toc -->
...
_Please note_: We take Ory hydra-client-typescript-fetch's security and our users' trust very
seriously. If you believe you have found a security issue in Ory hydra-client-typescript-fetch,
...
hydra-client-typescript-fetch's direction. A great way to
do this is via
[Ory hydra-client-typescript-fetch Discussions](https://github.com/orgs/ory/discussions)
or the [Ory Chat](https://www.ory.sh/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/hydra-client-typescript-fetch/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory hydra-client-typescript-fetch?](#communication)
...
- I want to talk to other Ory hydra-client-typescript-fetch users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  hydra-client-typescript-fetch.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/hydra-client-typescript-fetch)

- I would like updates about new versions of Ory hydra-client-typescript-fetch.
...
[list of good first issues](https://github.com/ory/hydra-client-typescript-fetch/labels/good%20first%20issue).

There are many other ways you can contribute. Here are a few things you can do
to help out:

- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory hydra-client-typescript-fetch.
...
- **Help with open issues.** We have a lot of open issues for Ory hydra-client-typescript-fetch and
...
Check out [Ory hydra-client-typescript-fetch Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory hydra-client-typescript-fetch,
...
before getting started to ensure your work is consistent with Ory hydra-client-typescript-fetch's
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/hydra-client-typescript-fetch/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/hydra-client-typescript-fetch).
...
git clone git@github.com:ory/ory/hydra-client-typescript-fetch.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/hydra-client-typescript-fetch.git
